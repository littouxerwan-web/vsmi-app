...
import { BarChart3, Bitcoin, Landmark, PiggyBank, SlidersHorizontal, X } from "lucide-react";
import { saveDashboardColors } from "@/app/(app)/aujourd-hui/actions";
