...
export function CategoryBudgetAnalysis({
  ...
  return (
    <details id="analyse-categories-budgets" open className="group scroll-mt-24 rounded-3xl border border-black/10 bg-white px-5 shadow-sm">
      <summary className="flex cursor-pointer list-none items-center justify-between gap-4 py-5">
        <span>
          <span className="block font-semibold">Analyse catégories et budgets</span>
          <span className="mt-1 block text-sm text-neutral-500">
            Analyse les 12 derniers mois et distingue les dépenses essentielles des dépenses facultatives.
          </span>
        </span>
        <span className="grid size-8 shrink-0 place-items-center rounded-full bg-neutral-100 transition group-open:rotate-180">
          <ChevronDown size={17} />
        </span>
      </summary>
